...
// NewTimeoutHandler is a handler that closes the connecion suddenly. this is one of the test utilities.
...
// NewTimeoutHandlerWithClient is a handler that timeout is occured. this is one of the test utilities.
